...
def parse_args():
  ...
  # parser.add_argument('-model_path', type=str, default='/home/zhren/BreastGAN/idinvert/results/00012-stylegan-encoder-4gpu-256x256-breast/network-snapshot-06500000.pkl',
  #                     help='Path to the pre-trained model.') # Brest GAN model
  # parser.add_argument('-image_list', type=str, default='/home/zhren/BreastGAN/idinvert/data/online_similarity/img_inv.list',
                      # help='List of images to invert.') # Brest GAN model
  # parser.add_argument('-model_path', type=str, default='/home/zhren/BreastGAN/idinvert/results/00017-stylegan-encoder-4gpu-128x128-mooney_full/network-snapshot-02650000.pkl',
  #                     help='Path to the pre-trained model.') # Mooney Model
  parser.add_argument('-model_path', type=str, default='/home/zhren/BreastGAN/idinvert/results/00015-stylegan-encoder-4gpu-128x128-mooney_full/network-snapshot-02050000.pkl',
                      help='Path to the pre-trained model.') # Mooney Model
  parser.add_argument('-image_list', type=str, default='/home/zhren/BreastGAN/idinvert/data/mooney_test.list',
                      help='List of images to invert.') # Mooney Model
  ...
  parser.add_argument('--learning_rate', type=float, default=0.01,
                      help='Learning rate for optimizYation. (default: 0.01)')
