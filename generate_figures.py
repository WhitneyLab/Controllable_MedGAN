...
file_breast = '/home/zhren/BreastGAN/idinvert/results/00002-sgan-breast-4gpu-wgangp/network-snapshot-007726.pkl'
file_CT = '/home/zhren/BreastGAN/idinvert/results/00022-sgan-deeplesion-4gpu-wgangp/network-snapshot-011322.pkl'
# file_Mooney = '/home/zhren/BreastGAN/idinvert/results/00016-sgan-mooney-4gpu-wgangp/network-snapshot-009508.pkl'
file_Mooney = '/home/zhren/BreastGAN/idinvert/results/00014-sgan-breast-4gpu-wgangp/network-snapshot-012509.pkl'
file_MRI = '/home/zhren/BreastGAN/idinvert/results/00024-sgan-fastMRI-4gpu-wgangp/network-snapshot-006122.pkl'
file_skin = '/home/zhren/BreastGAN/idinvert/results/00026-sgan-skin-4gpu-wgangp/network-snapshot-008122.pkl'
file_skin_HAM = '/home/zhren/BreastGAN/idinvert/results/00030-sgan-HAM-4gpu-wgangp/network-snapshot-008122.pkl'
...
def generate_mooney_centroid(out_dir, inv_codes_file, Gs):
    print(out_dir)
    # os.mkdir(out_dir)

    inv_codes = np.load(inv_codes_file)
    # print(np.sum(inv_codes, axis=0).shape)
    # print(inv_codes.shape[0])
    avg_code = np.sum(inv_codes, axis=0)/inv_codes.shape[0]
    images = Gs.run(avg_code, None, **synthesis_kwargs)
    image_iter = iter(list(images))
    image = PIL.Image.fromarray(next(image_iter), 'RGB')

    filename = out_dir + '/mooney_centro5.jpg'
    image.save(filename)

def generate_figures(out_dir, Gs, nums, seed):
    print(out_dir)
    os.mkdir(out_dir)
...
def main():
    ...
    # generate_figures('/home/zhren/BreastGAN/idinvert/results/Uncondition_images_1000_3',load_Gs(file_breast),1000,seed=3)
    # generate_figures('/home/zhren/BreastGAN/idinvert/results/Uncondition_CT_1000_1',load_Gs(file_CT),1000,seed=3)
    # generate_figures('/home/zhren/BreastGAN/idinvert/results/Uncondition_MRI_100_1',load_Gs(file_MRI),100,seed=3)
    # generate_figures('/home/zhren/BreastGAN/idinvert/results/Uncondition_skin_20000_1',load_Gs(file_skin),20000,seed=6)
    generate_figures('/home/zhren/BreastGAN/idinvert/results/Uncondition_skin_HAM_20000_1',load_Gs(file_skin_HAM),20000,seed=6)
    # generate_mooney_centroid('/home/zhren/BreastGAN/idinvert/results/Mooney_Centroid','/home/zhren/BreastGAN/idinvert/results/inversion/mooney_test/inverted_codes.npy',load_Gs(file_Mooney))
    # draw_uncurated_result_figure(os.path.join(config.result_dir, 'figure02-uncurated-ffhq.png'), load_Gs(file_breast), cx=0, cy=0, cw=256, ch=256, rows=3, lods=[0,1,2,2,3,3], seed=5)
