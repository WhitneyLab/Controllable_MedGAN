...
# Data_dir        = EasyDict(data_train='/home/zhren/BreastGAN/idinvert/datasets/encoder_train/encoder_train-r08.tfrecords', data_test='/home/zhren/BreastGAN/idinvert/datasets/encoder_test/encoder_test-r08.tfrecords') # Breast GAN model
# Data_dir        = EasyDict(data_train='/home/zhren/BreastGAN/idinvert/datasets/mooney_wNoise_enc_train/mooney_wNoise_enc_train-r07.tfrecords', data_test='/home/zhren/BreastGAN/idinvert/datasets/mooney_wNoise_enc_test/mooney_wNoise_enc_test-r07.tfrecords') # Mooney Model
Data_dir        = EasyDict(data_train='/home/zhren/BreastGAN/idinvert/datasets/skin/skin-r08.tfrecords', data_test='/home/zhren/BreastGAN/idinvert/datasets/skin/skin-r08.tfrecords') # Skin model
# Decoder_pkl     = EasyDict(decoder_pkl='/home/zhren/BreastGAN/idinvert/results/00002-sgan-breast-4gpu-wgangp/network-snapshot-006526.pkl') # Breast GAN model
# Decoder_pkl     = EasyDict(decoder_pkl='/home/zhren/BreastGAN/idinvert/results/00016-sgan-mooney-4gpu-wgangp/network-snapshot-009508.pkl') # Mooney Model
Decoder_pkl     = EasyDict(decoder_pkl='/home/zhren/BreastGAN/idinvert/results/00026-sgan-skin-4gpu-wgangp/network-snapshot-008122.pkl') # Skin Model
...
dataset = 'skin';       desc += '-skin';          train.mirror_augment = True

z_dim = 512

minibatch_per_gpu_train = {128: 4, 256: 4}
...
def main():
    ...
    kwargs.lr_args.decay_step = train.max_iters // 40
