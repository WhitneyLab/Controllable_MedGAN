...
if 1:
    ...
    desc += '-HAM';     dataset = EasyDict(tfrecord_dir='HAM');                 train.mirror_augment = True
    ...
    desc += '-4gpu'; submit_config.num_gpus = 4; sched.minibatch_base = 4; sched.minibatch_dict = {4: 256, 8: 128, 16: 64, 32: 32, 64: 16, 128: 4}
